...
\begin{landscape}
 ...
 \pagebreak
  ...
  \hline
  -9999 -1 & Maximum total catch by area & \multirow{1}{1cm}[-0.1cm]{\parbox{11cm}{Must enter value for each area. Starting in version 3.3 this now also includes surveys which are treated similar to fleets.}} \\
     & -1 = no maximum & \\
