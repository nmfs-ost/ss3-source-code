...
\begin{center}
	\begin{longtable}{p{2.75cm} p{2.75cm} p{2.75cm} p{2.75cm} p{3.5cm}}

		Value & Description & & Options & \\
		\hline
		1 & \multicolumn{2}{l}{Variance Adjustment Factors } & \multicolumn{2}{l}{0 = none, 1 = read table}\\
		\\
		\multicolumn{5}{l}{There are six rows and a value for each Fleet \& Survey on each row.}\\
		\\
...
The codes for component are:\\
	1 = survey; 2 = discard; 3 = mean weight; 4 = length; 5 = age; 6 = size frequency; 7 = size-at-age; 8 = catch; 9 = initial equilibrium catch; 10 = recruitment deviations; 11 = parameter priors; 12 = parameter deviations; 13 = crash penalty; 14 = morph composition; 15 = tag composition; 16 = tag negbin.
\\
\\
On output to control.ss\_new, the full table is written:
\begin{center}
	\begin{longtable}{p{2cm} p{2cm} p{2cm} p{2cm} p{5cm}}
