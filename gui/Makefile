#############################################################################
# Makefile for building: StockSynthesis
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Jan 28 14:03:08 2016
# Project:  StockSynthesis.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe -spec ..\..\..\Qt\4.8.6\mkspecs\win32-g++ -o Makefile StockSynthesis.pro
#############################################################################
...
Makefile: StockSynthesis.pro  ../../../Qt/4.8.6/mkspecs/win32-g++/qmake.conf ../../../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec ..\..\..\Qt\4.8.6\mkspecs\win32-g++ -o Makefile StockSynthesis.pro
