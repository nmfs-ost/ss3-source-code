...
!!version_info+= "SS-V3.30.05.02-safe;_2017_06_28;_Stock_Synthesis_by_Richard_Methot_(NOAA)_using_ADMB_11.6";
!!version_info2+="SS-V3.30.05.02-safe;user_support_available_at:NMFS.Stock.Synthesis@noaa.gov";
!!version_info3+="SS-V3.30.05.02-safe;user_info_available_at:https://vlab.ncep.noaa.gov/group/stock-synthesis";
!!version_info_short+="#V3.30.05.02";
