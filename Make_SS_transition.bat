...
copy/b SS_readdata_324.tpl+SS_readcontrol_324.tpl+SS_param.tpl+SS_prelim.tpl+SS_global.tpl+SS_proced.tpl+SS_timevaryparm.tpl+SS_functions.temp "C:\Users\richard.methot\Documents\SS_model\Compile\SS3_3.tpl"
