...
cd "C:\Users\richard.methot\Documents\SS_model\Compile"
C:\ADMB_12.0_use\bin\tpl2cpp ss_trans

pushd "%VS140COMNTOOLS%\..\..\VC" & call vcvarsall.bat amd64 & popd
cl /c /nologo /EHsc /O2 /I. /I"C:\ADMB_12.0_use" /I"C:\ADMB_12.0_use\include" /I"C:\ADMB_12.0_use\contrib\include" /Foss.obj ss_trans.cpp

cl /Fess_trans.exe ss.obj "C:\ADMB_12.0_use\lib\admb-contrib.lib" /link
