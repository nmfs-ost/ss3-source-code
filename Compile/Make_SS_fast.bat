...
docker run --rm --volume %CD%:\ss3-source-code\Compile --workdir \ss3-source-code\Compile johnoel/admb:linux -f ss_opt.tpl
REM docker run --rm --volume %CD%:\ss3-source-code\Compile --workdir \ss3-source-code\Compile johnoel/admb:linux -f ss_opt.tpl