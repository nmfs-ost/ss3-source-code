...
docker run --rm --volume %CD%:\ss3-source-code\Compile --workdir \ss3-source-code\Compile docker -f ss_opt.tpl
REM docker run --rm --volume %CD%:\ss3-source-code\Compile --workdir \ss3-source-code\Compile docker -f ss_opt.tpl