...
cl /c /nologo /EHsc /O2 /I. /I"C:\ADMB_12.0_use" /I"C:\ADMB_12.0_use\include" /I"C:\ADMB_12.0_use\contrib\include" /Foss.obj ss.cpp

cl /Fess.exe ss.obj "C:\ADMB_12.0_use\lib\admb-contrib.lib" /link
